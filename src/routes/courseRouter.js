...
const { addNewCourse, fetchAllCourses, fetchCourseById, fetchCourseByTeacher, insertModule, removeCourseSession, addNewComment } = require('../controllers/courseController');
